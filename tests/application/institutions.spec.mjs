...
describe('`#application/institutions`', () => {
  describe('getChangedInstitutions()', () => {
    describe('Institutions are changed', () => {
      const was = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'C' }] }
      const now = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'X' }] }

      it('returns an array of changed institutions', () => expect(getChangedInstitutions(was, now)).to.eql([{ iid: 'C', name: 'X' }]))
    })

    describe('Institutions are not changed', () => {
      const was = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'C' }] }
      const now = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'C' }] }
    ...
    describe('Institutions are removed', () => {
      const was = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'C' }] }
      const now = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }] }
    ...
    describe('Institutions are changed or removed', () => {
      const was = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'C' }] }
      const now = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'X' }] }

      it('returns an array of changed institutions', () => expect(getChangedInstitutions(was, now)).to.eql([{ iid: 'B', name: 'X' }]))
    })

    describe('Institutions are added', () => {
      const was = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'C' }] }
      const now = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'C' }, { iid: 'D', name: 'D' }] }
    ...
    describe('Institutions are changed or added', () => {
      const was = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'C' }] }
      const now = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'X' }, { iid: 'D', name: 'D' }] }
    ...
    describe('Institutions are changed or removed or added', () => {
      const was = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'C' }] }
      const now = { rows: [{ iid: 'A', name: 'A' }, { iid: 'C', name: 'X' }, { iid: 'D', name: 'D' }] }
  ...
  describe('getRemovedInstitutions()', () => {
    ...
    describe('Institutions are removed', () => {
      ...
      it('returns an array of removed institutions', () => expect(getRemovedInstitutions(was, now)).to.eql([{ iid: 'C', name: 'C' }]))
    })
    ...
    describe('Institutions are changed or removed or added', () => {
      ...
      it('returns an array of removed institutions', () => expect(getRemovedInstitutions(was, now)).to.eql([{ iid: 'B', name: 'B' }]))
    })
  })
  ...
  describe('hasRemovedInstitutions()', () => {
    ...
    describe('Institutions are removed or added', () => {
      const was = { rows: [{ iid: 'A', name: 'A' }, { iid: 'B', name: 'B' }, { iid: 'C', name: 'C' }] }
      const now = { rows: [{ iid: 'A', name: 'A' }, { iid: 'C', name: 'C' }, { iid: 'D', name: 'D' }] }
  ...
  describe('getAddedInstitutions()', () => {
    ...
    describe('Institutions are added', () => {
      ...
      it('returns an array of added institutions', () => expect(getAddedInstitutions(was, now)).to.eql([{ iid: 'D', name: 'D' }]))
    })
