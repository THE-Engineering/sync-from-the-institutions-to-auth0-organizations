...
describe('`#application/organizations`', () => {
  describe('getChangedOrganizations()', () => {
    describe('Organizations are changed', () => {
      ...
      const now = [
        { name: 'A', display_name: 'A' },
        { name: 'B', display_name: 'B' },
        { name: 'C', display_name: 'X' },
      ]

      it('returns an array of changed organizations', () =>
        expect(getChangedOrganizations(was, now)).to.eql([
          { name: 'C', display_name: 'X' },
        ]))
    })
  ...
  describe('getRemovedOrganizations()', () => {
    ...
    describe('Organizations are removed', () => {
      ...
      it('returns an array of removed organizations', () =>
        expect(getRemovedOrganizations(was, now)).to.eql([
          { name: 'C', display_name: 'C' },
        ]))
    })
  ...
  describe('getAddedOrganizations()', () => {
    ...
    describe('Organizations are added', () => {
      ...
      it('returns an array of added organizations', () =>
        expect(getAddedOrganizations(was, now)).to.eql([
          { name: 'D', display_name: 'D' },
        ]))
    })
