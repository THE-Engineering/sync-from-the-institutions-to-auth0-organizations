...
Without a _nap_ the `organization` will run once and stop

With a _nap_ the `organization` application will run then halt (for the duration of the `NAP`) then run again
